...
function ImportJSONAdvanced(url, query, options, includeFunc, transformFunc) {
  var aa={
    "authority": "www.vlive.tv",
    "method": "GET",
    "path": "/globalv-web/vam-web/post/v1.0/board-3484/posts?appId=8c6cc7b45d2568fb668be6e05b6e5a3b&fields=attachments,author,availableActions,board%7BboardId,title,boardType,payRequired,includedCountries,excludedCountries%7D,channel%7BchannelName,channelCode%7D,totalCommentCount,contentType,createdAt,emotionCount,excludedCountries,includedCountries,isCommentEnabled,isHiddenFromStar,lastModifierMember,notice,officialVideo,plainBody,postId,postVersion,reservation,starReactions,targetMember,thumbnail,title,url,writtenIn,sharedPosts",
    "scheme": "https",
    "accept": "application/json, text/plain, */*",
    "accept-encoding": "gzip, deflate, br",
    "accept-language": "ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7",
    "cookie": "timezoneOffset=0; userLanguage=ko; webp=true; _ga=GA1.2.1601514150.1615696581; _gid=GA1.2.366133784.1615696581; RTT_TIMESTAMP=false,1615698584.719,1615698584719,1615698584735,1615698584.738; userCountry=KR; X-V-Device-Id=43936705-298a-486a-8217-e843d3619047; JSESSIONID=23F60093BBF6E7CD6452257D069ED6B8",
    "origin": "https://m.vlive.tv",
    "pragma": "no-cache",
    "referer": "https://m.vlive.tv/channel/EDBF/board/3484",
    "sec-fetch-dest": "empty",
    "sec-fetch-mode": "cors",
    "sec-fetch-site": "same-site",
    "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.135 Safari/537.36",
    "x-v-device-id": "43936705-298a-486a-8217-e843d3619047"
  }
  var settings = {
  "async": true,
  "crossDomain": true,
  "url": "https://www.klook.com/xos_api/v1/websrv/cities/29/activities?page=1&order=0&limit=24&_=1514508578891",
  "method": "GET",
  "headers": aa
};
  var object   = JSON.parse(UrlFetchApp.fetch(url,settings).getContentText());
